...
const SelectClient = () => {
  ...
  const handleInvoiceCreated = () => {
    // Close modal and optionally refresh the page or show success message
    setShowCreateInvoiceModal(false);
    setSelectedClientId(null);
  ...
  return (
    <>
      ...
      {showCreateInvoiceModal && selectedClientId && (
          ...
          <div className="bg-white rounded-xl shadow-lg w-full max-w-7xl max-h-[90vh] overflow-y-auto m-4">
            <div className="sticky top-0 bg-white border-b border-gray-200 p-4 flex justify-between items-center">
              <h2 className="text-xl font-semibold text-gray-900">
                Create Invoice for {clients.find(c => c.id === selectedClientId)?.name}
              </h2>
              <CustomButton
                leftIcon={<ArrowBack />}
                color="#F0F1F4"
