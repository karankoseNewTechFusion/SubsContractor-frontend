    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {vendors.map((vendor, index) => (
          <div
            key={index}
            className="bg-white rounded-lg border shadow-md p-4 hover:shadow-lg transition"
          >
            <div className="flex justify-between items-start mb-2">
              <div>
              ...
              <div className="flex gap-2">
                <button title="Edit">
                  <Edit className="text-gray-500 hover:text-blue-600" fontSize="small" />
                </button>
                <button title="Delete">
                  <Delete className="text-gray-500 hover:text-red-600" fontSize="small" />
                </button>
              </div>
            </div>
