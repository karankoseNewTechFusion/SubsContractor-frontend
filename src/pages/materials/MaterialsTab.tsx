...
//   const [materials, setMaterials] = useState(initialData.items);
...
//             className="border px-4 py-2 rounded-md text-sm w-full sm:w-[400px] md:w-[500px] lg:w-[600px]"
//             value={searchQuery}
...
//         <div>
//           <h3 className="text-xl font-semibold text-gray-900">{initialData.title}</h3>
//           <p className="text-gray-500 text-sm">{initialData.description}</p>
//         </div>
//         <div className="flex items-center gap-4">
//           <span className="text-sm text-gray-600">
//             {initialData.totalMaterials} Materials - {initialData.totalCost}
//           </span>
...
//                   onClick={() => updateStatus(index, "Ordered")}
//                 >
//                   Order
//                 </button>
//               )}
